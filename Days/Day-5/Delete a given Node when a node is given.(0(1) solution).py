...
# ----------------------------------------------------------------------
# Approach 1: The Node that has to be deleted, it's value would be replaced by the next node it is pointing to. Also it's next is changed with it's next node's next.
