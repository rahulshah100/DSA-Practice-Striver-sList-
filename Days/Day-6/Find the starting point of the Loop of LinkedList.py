...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------
# Approach1: Using a hashmap. Traverse the linked list while checking for every node if the node's id is present in hashmap. If so, return the head, if not then store the node's id.
