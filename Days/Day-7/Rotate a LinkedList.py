...
# 0 <= k <= 2 * 10^9
# --------------------------------------------------------------------------------------------------------------------------------
# Approach1: Given a linked list, for the given k, for k times we'll repeat the process where in: everytime we'll traverse till the second last node and will point it to None, alongside making the last node point to the head.
