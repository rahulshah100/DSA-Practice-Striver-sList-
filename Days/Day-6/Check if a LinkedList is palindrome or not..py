...
# 0 <= Node.val <= 9
# ----------------------------------------------------------------------------------------------------------------------------------
# Approach 1: 2 Pointers Method=> As in singly linked list reverse traversal is not possible by default, so to keep comparing the front and back items, we make the given linked list into an array, and use a starting and ending pointers to compare items.
